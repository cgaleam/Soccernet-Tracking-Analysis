...
\begin{figure}[htp]
\centering
\includegraphics[width=0.85\textwidth]{figures/arquitectura_general.drawio.png}
...
anteriores: el estudio de hiperparámetros
se apoya en resultados de tracking ya calculados, y el pipeline de
metadatos se apoya en la configuración
...
aplicando el algoritmo de tracking correspondiente. Se compone de tres bloques de
...
posiciones de la secuencia, y el mapa \textbf{por equipo}, que separa las posiciones según la
