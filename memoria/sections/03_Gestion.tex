...
\begin{itemize}
  \item \textbf{Jefe de proyecto.} Es el responsable de la planificación
        ...
        preparación y el seguimiento de las reuniones con el tutor, la
  ...
  \item \textbf{Ingeniero de Visión Artificial.} Es el perfil técnico
        ...
        correspondería a un científico de datos, adaptado especificamente
...
desarrollo mediante reuniones periódicas de seguimiento. Su papel ha sido de gran importancia, ya que muchas de las
...
responsable (sección~\ref{sec:gestion-roles}) y las horas dedicadas. La
...
\hline
1.3 & Análisis de requisitos (capítulo~\ref{cap:analisis}) &
...
5.2 & Homografía real (distancia/velocidad) y posesión de balón &
  Ingeniero de Visión Artificial & 25\,h \\
\hline
6.1 & Desarrollo de la aplicación web & Desarrollador & 40\,h \\
\hline
6.2 & Ajustes y revisión de la aplicación web (retoques de septiembre) &
  Desarrollador & 15\,h \\
\hline
8.1 & Organización del repositorio y corrección de errores &
  Desarrollador & 20\,h \\
\hline
9.1 & Redacción de la memoria & Jefe de proyecto & 65\,h \\
\hline
\rowcolor{gray!10}
 & \textbf{Total} & & \textbf{320\,h} \\
\hline
\end{tabular}
\end{table}

Esta cifra final, superior a las 235\,h estimadas en la planificación
...
El proyecto se inició a finales de abril de 2026, con una disponibilidad de
tiempo muy variable a lo largo de los meses siguientes debido al
solapamiento con la época de exámenes del resto de asignaturas del grado.
Esta irregularidad, previsible desde el principio dado el calendario
académico, condicionó la forma de planificar: en lugar de repartir el
esfuerzo de manera uniforme mes a mes, la planificación inicial asumió
explícitamente periodos de baja dedicación durante los exámenes de mayo y
concentró el grueso del trabajo en los meses sin solapamiento académico. La
planificación inicial, elaborada durante las primeras semanas del
...
\begin{itemize}
  ...
  \item \textbf{Mayo} -- Ritmo muy reducido por exámenes (aproximadamente
        ...
        una reunión de seguimiento con el tutor.
...
La estimación total de esta planificación inicial fue de unas 235 horas,
de las cuales aproximadamente 65 se reservaron como margen para imprevistos
y tiempo de tutorías, con una fecha de entrega prevista a finales de julio
...
\begin{table}[htp]
\centering
\caption{Cronograma real del proyecto por fase y mes. El tono claro
distingue actividad parcial o de repaso/retoque frente al grueso del
trabajo de cada fase (tono oscuro).}
\label{tab:gestion-gantt}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{|p{3.6cm}|c|c|c|c|c|c|c|}
\hline
\rowcolor{gray!25}
\textbf{Fase} & \textbf{Abr} & \textbf{May} & \textbf{Jun} & \textbf{Jul} & \textbf{Ago} & \textbf{Sep} & \textbf{Oct} \\
\hline
1. Exploración inicial & \cellcolor{blue!25}\checkmark & & & & & & \\
\hline
...
\hline
5. Pipeline de metadatos & & & \cellcolor{blue!25}\checkmark & \cellcolor{blue!25}\checkmark & & & \\
\hline
...
Como refleja el cronograma, la fase 7 no se concentra limpiamente en un
único tramo: arranca de forma parcial en junio y julio, se convierte en el
grueso real del trabajo en agosto y septiembre, y se cierra con una
revisión final en octubre antes de la entrega. La fase 6 sigue un patrón
similar a menor escala: desarrollo principal de la aplicación web en
agosto, con retoques y correcciones puntuales en septiembre
...
herramienta de \emph{time-tracking} dedicada (Figura~\ref{fig:gestion-monitorizacion}),
complementada por el documento de anotaciones descrito en la
sección~\ref{sec:gestion-metodologia} y por el historial de commits del
repositorio Git, cuya fecha permite además reconstruir con razonable
precisión cuándo se completó cada hito (Tabla~\ref{tab:gestion-hitos}). Las
...
\centering
\vspace{2.5cm}
\textbf{[Figura pendiente]}\\[0.3cm]
Captura de la herramienta de \emph{time-tracking} empleada durante el
desarrollo del proyecto si es necesario.
\vspace{2.5cm}
\end{minipage}}
\caption{(pendiente de incorporar la captura).}
...
\hline
Junio--julio 2026 & Pipeline de metadatos: mapa de calor general,
  clasificación de equipos por color y mapas de calor por equipo. \\
\hline
Julio 2026 & Homografía real sobre tramos de cámara estable (distancia y
  velocidad); posesión de balón por proximidad. \\
\hline
...
\hline
Septiembre 2026 & Ajustes y correcciones sobre la aplicación web;
  continuación y revisión de la memoria. \\
\hline
...
\begin{itemize}
  ...
  \item \textbf{Redacción de la memoria más tardía y más costosa de lo
        ...
        redacción sistemática --con el nivel de detalle y de contraste
        contra el código real que exige esta memoria-- no arrancó en
  ...
  \item \textbf{Periodo de exámenes y viajes durante el verano}: además
        del solapamiento ya previsto con los exámenes de mayo
        (sección~\ref{sec:gestion-planificacion}), varios periodos de
  ...
  \item \textbf{Retraso inicial por la exploración de alternativas}: la
        ...
        (sección~\ref{sec:gestion-fases}) llevó más tiempo del previsto,
  ...
  \item \textbf{Incidencias con el equipo de desarrollo}: un problema con
        ...
        uso ya habitual de un equipo de sobremesa
        (sección~\ref{sec:gestion-entorno}); recrear el entorno en cada
        cambio de equipo consumió tiempo no planificado.
\end{itemize}
...
causas, la dedicación real asciende a las \textbf{320\,h} recogidas en el
diccionario de la EDT (Tabla~\ref{tab:gestion-edt-diccionario}), 85\,h por
encima de las 235\,h de la planificación inicial. La
...
Redacción de la memoria & En paralelo desde junio, cerrada en julio &
  Grueso del trabajo entre julio y agosto, continuación en septiembre y
  revisión final en octubre \\
\hline
Aplicación web & Prevista en julio & Desarrollada en agosto de 2026, con
  retoques en septiembre, tras completar el pipeline de metadatos y en
  paralelo a la redacción de los últimos capítulos de esta memoria \\
\hline
Horas totales dedicadas & 235\,h (planificación inicial) & 320\,h
...
consumió tiempo no contemplado en la planificación inicial
(sección~\ref{subsec:gestion-revision}). Dado que
...
(véase capítulo~\ref{cap:conclusiones}).
...
visión artificial} --una especialización posterior a esa taxonomía--,
...
realmente dedicadas (320\,h, Tabla~\ref{tab:gestion-edt-diccionario}),
repartidas por rol de acuerdo con el diccionario de la EDT.

\begin{table}[htp]
\centering
\caption{Estimación de costes de personal sobre las 320\,h reales dedicadas al proyecto.}
...
\hline
Jefe de proyecto & Gestor de proyecto & 65\,h & 44{,}12\,€ & 2\,867{,}80\,€ \\
\hline
Analista de software & Analista de negocio & 15\,h & 33{,}17\,€ & 497{,}55\,€ \\
\hline
Ingeniero de Visión Artificial & Arquitecto de sistemas & 155\,h & 33{,}45\,€ & 5\,184{,}75\,€ \\
\hline
Desarrollador & Desarrollador & 85\,h & 25{,}67\,€ & 2\,181{,}95\,€ \\
\hline
\rowcolor{gray!10}
\textbf{Total} & & \textbf{320\,h} & & \textbf{10\,732{,}05\,€} \\
\hline
\end{tabular}
\end{table}
...
320\,h de dedicación se han realizado con el equipo de mayor consumo-- y
las 320\,h totales del proyecto (Tabla~\ref{tab:gestion-edt-diccionario}):
$150\,\mathrm{W} \times 320\,\mathrm{h} = 48\,\mathrm{kWh}$, que al precio
medio doméstico de la electricidad en España (en torno a 0{,}16\,€/kWh)
supone un coste estimado de \textbf{7{,}68\,€} a lo largo de todo el
proyecto.
...
\hline
Consumo eléctrico ($150\,\mathrm{W} \times 320\,\mathrm{h} = 48\,\mathrm{kWh}$
  a 0{,}16\,€/kWh) & 7{,}68\,€ \\
\hline
\rowcolor{gray!10}
\textbf{Total cuantificado} & \textbf{7{,}68\,€} \\
\hline
\end{tabular}
\end{table}
...
real (320\,h) ha superado en 85\,h la planificación inicial de 235\,h,
...
reparto por rol de las 235\,h de la planificación inicial (30\,h jefe de
proyecto, 15\,h analista, 130\,h ingeniero de Visión Artificial, 60\,h
desarrollador) y el mismo criterio de consumo eléctrico sobre esas 235\,h
($150\,\mathrm{W} \times 235\,\mathrm{h} = 35{,}25\,\mathrm{kWh}$, a
...
\begin{table}[htp]
\centering
\caption{Coste total estimado (planificación inicial, 235\,h) frente a
coste real (320\,h) y desviación.}
...
\hline
Personal (Tabla~\ref{tab:gestion-costes-personal}) & 7\,709{,}85\,€ &
  10\,732{,}05\,€ & +3\,022{,}20\,€ \\
\hline
...
\hline
\rowcolor{gray!10}
\textbf{Total} & \textbf{7\,715{,}49\,€} & \textbf{10\,739{,}73\,€} &
  \textbf{+3\,024{,}24\,€ (+39\,\%)} \\
\hline
\end{tabular}
\end{table}

La desviación de coste total, en torno al 39\,\%, es algo mayor que la
desviación de horas (85\,h sobre 235\,h, un 36\,\%) porque las horas
añadidas se concentran en los roles de tarifa más alta (jefe de proyecto
e ingeniero de Visión Artificial); el consumo eléctrico, al ser
proporcional a las horas totales, se desvía exactamente en esa misma
proporción (36\,\%) pero su magnitud absoluta es tan pequeña que apenas
afecta al total. La Tabla~\ref{tab:gestion-desviaciones} documenta el
resto de desviaciones respecto a la planificación inicial, no solo la de
coste.
...
revisado en cada reunión de seguimiento con el tutor, incorporando riesgos
...
Disponibilidad de tiempo irregular por exámenes &
  ...
  (sección~\ref{subsec:gestion-revision}) \\
\hline
