...
El análisis de datos es una disciplina de la informática que me apasiona, asi como 
...
\begin{itemize}
  ...
  \item \textbf{OE-11:} Desarrollar una aplicación web que sirva como
        ...
        resultados de tracking y el análisis de datos generado. Tambien se
...
asociación (tracking), no en el diseño de un detector de objetos propio. De
todas formas, conviene precisar otros límites del proyecto desde el
principio:

\begin{itemize}
  \item Los algoritmos comparados corresponden a la familia de métodos
        \emph{tracking-by-detection} clásicos, sin componente de
        reidentificación visual profunda (\emph{re-ID}); la incorporación de
  ...
  \item La proyección de posiciones de píxel a coordenadas reales del campo
        ...
        aproximación por rango observado (sin calibración de cámara), usada
...
\begin{itemize}
  \item \textbf{Capítulo~\ref{cap:fundamentos} -- Fundamentos teóricos y
        estado del arte.}
        Presenta los conceptos teóricos necesarios para entender el
        proyecto: el problema del seguimiento multiobjeto, los algoritmos
        ...
        homografía entre otros; y cierra situando este TFG frente a los
  ...
  \item \textbf{Capítulo~\ref{cap:implementacion} -- Implementación.}
        ...
        aplicación web, incluyendo los problemas técnicos encontrados y los
...
con los términos técnicos y las siglas usadas a lo largo de la memoria.
