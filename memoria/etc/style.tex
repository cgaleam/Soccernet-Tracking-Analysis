...
% ============================================================
% Actor UML (muñeco de palo) reutilizable en diagramas tikz de
% casos de uso. Uso: \actorfig{x}{y}{Etiqueta debajo del muñeco}
% ============================================================
\newcommand{\actorfig}[3]{%
  \draw (#1,#2+0.85) circle (0.18);
  \draw (#1,#2+0.67) -- (#1,#2+0.15);
  \draw (#1-0.28,#2+0.5) -- (#1+0.28,#2+0.5);
  \draw (#1,#2+0.15) -- (#1-0.24,#2-0.25);
  \draw (#1,#2+0.15) -- (#1+0.24,#2-0.25);
  \node[below, font=\footnotesize\bfseries, align=center, text width=2.4cm] at (#1,#2-0.28) {#3};
}

% Estilo de burbuja de caso de uso (elipse) para diagramas tikz
\tikzset{
  casouso/.style={draw, ellipse, fill=blue!8, align=center, font=\footnotesize, minimum width=3.4cm, minimum height=0.9cm}
}
