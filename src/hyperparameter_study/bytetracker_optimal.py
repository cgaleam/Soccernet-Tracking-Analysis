...
Resultados en:
    results_hyperparam/bytetracker/bytetracker_optimal/
    evaluation_hyperparam/bytetracker/bytetracker_optimal/
"""
...
def run_tracker(sequence_path):
    tracker  = BYTETracker(**OPTIMAL_PARAMS)
...
def evaluate():
    ...
    dataset_config['TRACKERS_FOLDER']    = os.path.join(BASE_DIR, '..', '..', 'results_hyperparam', 'bytetracker')
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("BYTETracker — Configuración óptima")
    ...
    print("\n" + "="*60)
    print("BYTETracker óptimo completado.")
